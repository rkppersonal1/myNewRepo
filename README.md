...
* Convert any string type to any other string type, for example:
  ...
  * Double quoted strings to template literals.
  ...
  ![Feature demo 1](https://github.com/adiessl/vscode-backtix/raw/HEAD/images/feature_demo_1.gif)
* If the target quote character is present in the string, it will be escaped upon conversion, already escaped quote characters will be "unescaped" upon conversion to another quote type.
  ![Feature demo 2](https://github.com/adiessl/vscode-backtix/raw/HEAD/images/feature_demo_2.gif)
* Multi-line template literals will be moved to a single line upon conversion, the newline characters will be inlined.
  ![Feature demo 3](https://github.com/adiessl/vscode-backtix/raw/HEAD/images/feature_demo_3.gif)
* Expressions in template placeholders will be concatenated with `+` symbols.
  ![Feature demo 4](https://github.com/adiessl/vscode-backtix/raw/HEAD/images/feature_demo_4.gif)
* Easily add placeholders (`${}`) in template literals.
  ![Feature demo 5](https://github.com/adiessl/vscode-backtix/raw/HEAD/images/feature_demo_5.gif)
...
![Installation](https://github.com/adiessl/vscode-backtix/raw/HEAD/images/installation.gif)
